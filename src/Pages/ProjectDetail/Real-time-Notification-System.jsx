  ...
  return (
    <Container className='w-full flex flex-col lg:flex-row gap-2 mt-10 lg:mt-20'>
      <div className="w-full flex flex-col items-start bg-white">
        ...
        <p className="text-[#131518] mb-2">Full-Time / Remote / <span className="text-green-500">$110</span></p>
        ...
        <div className="mb-8">
          ...
          <ul className="list-disc list-inside">
            <li><strong>Start Date:</strong> May 15, 2025</li>
            <li><strong>End Date:</strong> July 15, 2025</li>
