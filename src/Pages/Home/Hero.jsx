    ...
    >
      <Container className="flex flex-col justify-center items-center h-screen pb-16 px-4 lg:px-20 xl:px-32">
        <div className='text-center max-w-3xl'>
          <p className="font-bold pt-12 sm:mt-0 text-4xl md:text-7xl"><span className='text-[#E8B300]'>Ascend</span> <span className='text-[#E73015]'>Achieve</span> <span className='text-[#0559A5]'>Advance</span></p>
          <p className='py-16 text-sm'>Welcome to TechTalents City, where technology and talent converge to unleash your potential and create endless opportunities</p>
