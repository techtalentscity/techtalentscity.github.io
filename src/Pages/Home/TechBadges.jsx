...
const badges = [
    ...
    },
    {
      ...
      description: (
        <>
          Awarded to <strong>no-code developers and designers</strong> after the successful completion of each collaborative project.
        </>
      ),
      bg: '#F4F3FC'
    },
...
const TechBadges = () => {
  return (
    <Container className="bg-white my-12 md:my-16 py-16 !px-4 lg:!px-20 xl:!px-32">
      ...
      <p className="text-center mb-12 text-[#737373] max-w-2xl mx-auto">
      Advance your career with our innovative TechTalents badges, awarded based on the number of completed projects, showcasing your achievements and problem-solving skills.
      </p>
