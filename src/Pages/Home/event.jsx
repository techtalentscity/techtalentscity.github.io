...
const Events = () => {
  return (
    <Container className="flex flex-col lg:flex-row items-start lg:items-stretch gap-8 p-8 bg-white 2xl:px-36">
      {/* Left Section: Image */}
      <div className="flex-shrink-0 w-full lg:w-1/2 flex items-stretch">
        <img
          src={image}
          alt="Awards and Recognition"
          className="w-full h-auto lg:h-full rounded-3xl object-contain"
        />
      </div>
